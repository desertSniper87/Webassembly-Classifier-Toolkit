(module
  ...
  (func $_aesb_single_round (type 0) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    ...
    i32.xor
    i32.store offset=12)
  (func $f19 (type 0) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    i32.const 0
    call $env.abort)
  (func $f20 (type 6) (param $p0 i32) (param $p1 i32)
  ...
  (func $f27 (type 6) (param $p0 i32) (param $p1 i32)
    ...
    local.get $l0
    global.set 4)
  (func $_cryteknight_destroy (type 1) (param $p0 i32)
    (local $l0 i32) (local $l1 i32) (local $l2 i32) (local $l3 i32)
    local.get $p0
    i32.const 2097536
    i32.add
    ...
    local.get $p0
    call $f12)
  (func $_cryteknight_create (type 2) (result i32)
  ...
  (func $f34 (type 0) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    ...
    local.get $l0
    global.set 4)
  (func $_cryteknight_hash_variant_1 (type 7) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
    ...
    local.get $p3
    global.set 4)
  (func $_cryteknight_hash_variant_0 (type 7) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32)
  ...
  (export "_cryteknight_create" (func $_cryteknight_create))
  (export "_cryteknight_destroy" (func $_cryteknight_destroy))
  (export "_cryteknight_hash_variant_0" (func $_cryteknight_hash_variant_0))
  (export "_cryteknight_hash_variant_1" (func $_cryteknight_hash_variant_1))
  (export "_malloc" (func $_malloc))
  (export "stackAlloc" (func $stackAlloc))
  (elem (;0;) (global.get 0) func $f19 $f34 $f30 $f33 $f32 $f19 $f19 $f19)
